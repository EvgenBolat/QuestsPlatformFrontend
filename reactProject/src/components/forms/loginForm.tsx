      ...
      <div className="login">
        <form
          onSubmit={async (e) => {
            ...
            formData.append("service_id", "ebc9eafe-cb45-11ee-8c0c-00f5f80cf8ae");
            ...
            const data2 = await fetch(
              ...
              .then((responce) => responce.json()).then((response) => response.message.auth_token)
            ...
            //   taskIdParticipation !== ""
            // ) {
            //   console.log(questIdParticipation)
            //   console.log(taskIdParticipation)
            //   console.log("npc")
            //   navigate(`/setnpc/${questIdParticipation}/${taskIdParticipation}`);
            // } else 
            if (questIdParticipation && questIdParticipation !== "") {
              console.log("player")
        ...
        >
          ...
          <input
            value={email.value}
            onChange={(e) => {email.onChange(e); setValid(true)}}
          ...
          <input
            ...
            onChange={(e) => {password.onChange(e); setValid(true)}}
          ...
          <div id="ConfidenceBox">
            ...
            />
            <a href="https://ru.pinterest.com/pin/138274651046528518/">
          ...
          {email.isDirty &&
            password.isDirty &&
            (email.isEmpty || email.emailError || password.isEmpty || !isValid) && (
